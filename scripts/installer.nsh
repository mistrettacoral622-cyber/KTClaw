; KTClaw Custom NSIS Installer/Uninstaller Script
;
...
!macro customCheckAppRunning
  ...
  ; dialog during upgrades.  The built-in NSIS uninstaller deletes KTClaw.exe
