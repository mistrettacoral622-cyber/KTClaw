...
export function Chat() {
  ...
  return (
    <div className={cn('relative -m-6 flex h-[calc(100vh-2.5rem)] min-h-0 bg-background transition-colors duration-500 dark:bg-background')}>
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex shrink-0 items-center justify-between gap-4 border-b border-black/5 bg-background/90 px-6 pb-4 pt-5 dark:border-white/5">
          <div className="min-w-0">
            <p className="text-[12px] uppercase tracking-[0.14em] text-muted-foreground/80">
              {t('chat:toolbar.currentAgent', { agent: currentAgentName })}
            </p>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              type="button"
              className="rounded-full border border-black/10 px-4 py-2 text-[13px] font-medium text-foreground/80 transition-colors hover:bg-black/5 hover:text-foreground dark:border-white/10 dark:hover:bg-white/10"
            >
            ...
            <button
              type="button"
              className="rounded-full border border-primary/10 bg-primary/5 px-4 py-2 text-[13px] font-medium text-foreground transition-colors hover:bg-primary/10"
            >
        ...
        <div className="flex min-h-0 flex-1">
          <div className="flex min-w-0 flex-1 flex-col">
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-6 py-5">
              <div ref={contentRef} className="mx-auto flex min-h-full max-w-4xl flex-col space-y-4">
                {isEmpty ? (
