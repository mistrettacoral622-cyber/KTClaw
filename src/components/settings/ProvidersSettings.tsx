    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-black/5 dark:bg-white/5 rounded-3xl border border-transparent border-dashed">
          ...
          <Button onClick={() => setShowAddDialog(true)} className="rounded-full px-6 h-10 bg-[#0a84ff] hover:bg-clawx-ac text-white">
            <Plus className="h-4 w-4 mr-2" />
...
interface ProviderCardProps {
  ...
  onValidateKey: (
    key: string,
    options?: { baseUrl?: string; apiProtocol?: ProviderAccount['apiProtocol']; model?: string }
          ...
          {!selectedType ? (
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="rounded-xl bg-blue-500/10 border border-blue-500/20 p-5 text-center">
                      ...
                      <Button
                        ...
                        className="w-full rounded-full h-[42px] font-semibold bg-[#0a84ff] hover:bg-clawx-ac text-white shadow-sm"
                      >
                        {oauthFlowing ? (
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-5">
                          {oauthError ? (
                            ...
                            <div className="space-y-4 w-full">
                              ...
                              <Button
                                className="w-full rounded-full h-[42px] font-semibold bg-[#0a84ff] hover:bg-clawx-ac text-white"
              ...
              <div className="flex justify-end gap-3">
                <Button
                  onClick={handleAdd}
                  className={cn("rounded-full px-8 h-[42px] text-[13px] font-semibold bg-[#0a84ff] hover:bg-clawx-ac text-white shadow-sm", useOAuthFlow && "hidden")}
