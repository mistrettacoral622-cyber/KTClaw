...
if /i "%1"=="update" (
    echo openclaw is managed by KTClaw ^(bundled version^).
    echo.
    echo To update openclaw, update KTClaw:
    echo   Open KTClaw ^> Settings ^> Check for Updates
...
"%~dp0..\..\KTClaw.exe" "%~dp0..\openclaw\openclaw.mjs" %*
